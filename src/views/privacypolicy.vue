<template>
  <div class="privacy-policy">
    ...
    <p>Your website may use the Terms and Conditions given below.<br>
      The terms “We” / “Us” / “Our”/”Company” individually and collectively refer to Lucky Rummy and the terms “Visitor” ”User” refer to the users.<br>
    ...
    <p>All logos, brands, marks headings, labels, names, signatures, numerals, shapes or any combinations thereof, appearing in this site, except as otherwise noted, are properties either owned, or used under license, by the business and / or its associate entities who feature on this Website. The use of these properties or any other content on this site, except as provided in these terms and conditions or in the site content, is strictly prohibited.<br>
      ...
      You may not sell or modify the content of this Website or reproduce, display, publicly perform, distribute, or otherwise use the materials in any way for any public or commercial purpose without the respective organisation’s or entity’s written permission.</p>

    <h3>ACCEPTABLE WEBSITE USE</h3>
    <strong>(A) Security Rules</strong>
    <p>
      Visitors are prohibited from violating or attempting to violate the security of the Web site, including, without limitation, (1) accessing data not intended for such user or logging into a server or account which the user is not authorized to access, (2) attempting to probe, scan or test the vulnerability of a system or network or to breach security or authentication measures without proper authorisation, (3) attempting to interfere with service to any user, host or network, including, without limitation, via means of submitting a virus or “Trojan horse” to the Website, overloading, “flooding”, “mail bombing” or “crashing”, or (4) sending unsolicited electronic mail, including promotions and/or advertising of products or services. Violations of system or network security may result in civil or criminal liability. The business and / or its associate entities will have the right to investigate occurrences that they suspect as involving such violations and will have the right to involve, and cooperate with, law enforcement authorities in prosecuting users who are involved in such violations.</p>

    <strong>(B) General Rules</strong>
    <p>Visitors may not use the Web Site in order to transmit, distribute, store or destroy material (a) that could constitute or encourage conduct that would be considered a criminal offence or violate any applicable law or regulation, (b) in a manner that will infringe the copyright, trademark, trade secret or other intellectual property rights of others or violate the privacy or publicity of other personal rights of others, or (c) that is libelous, defamatory, pornographic, profane, obscene, threatening, abusive or hateful.</p>


    <h3>INDEMNITY</h3>

    <p>The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of Lucky Rummy. In or their breach of the terms.</p>

    <h3>ELIGIBILITY</h3>

    <p>1.Services Not Offered in Assam, Nagaland, Orissa, Sikkim and Telangana:<br>
      1.1	You are not a resident of any of the following states: Assam, Nagaland, Orissa, Sikkim and Telangana.<br>
      1.2	You are not logging in from any of the following states: Assam, Nagaland, Orissa, Sikkim and Telangana<br>
      1.3	You must satisfy yourself that it is legal for you to participate in Lucky Rummy in the specific jurisdiction from which you are accessing the Services.<br>

      The ‘Eligible Territory' is defined as being the territory of India excluding the states of Assam, Telangana, Orissa, Nagaland and Sikkim. ‘Lucky Rummy’ are defined as being any games or tournaments which are part of the Services and require the User to maintain a non-zero cash balance ("Cash Balance") in their Accounts. Any game other than a Lucky Rummy made available by the Company through the Platform or the Software, is defined as a 'Practice Game'. All Lucky Rummy and Practice Games shall be collectively defined as 'Games'.<br>
      2.In order to participate in Lucky Rummy, you must satisfy the following criteria at all times:<br>
      2.1	You must be at least 18 years old. and must not suffer from any disability or impairment which would prevent you from assuming the responsibilities contained in the Agreement, or from participating in the Games which are offered as part of the Services.<br>
      2.2	You must be an India citizen. <br>
      2.3	You must possess a valid PAN number, which will be associated with your account and which you will provide to us upon request.</p>
    ...
    <p>Your website may use the Privacy Policy given below:<br>
      The terms “We” / “Us” / “Our”/”Company” individually and collectively refer to Lucky Rummy and the terms “You” /”Your” / “Yourself” refer to the users.<br>
      This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.<br>
      This Privacy Policy is a legally binding document between you and Lucky Rummy (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Lucky Rummy for your use of the website “Website” (defined below).<br>
    ...
    <p>To avail certain services on our Websites, users are required to provide certain information for the registration process namely: – a) your name, b) email address, c) sex, d) age, e) PIN code, f) credit card or debit card details g) medical records and history h) sexual orientation, i) biometric information, j) password etc., and / or your occupation, interests, and the like. The Information as supplied by the users enables us to improve our sites and provide you the most user-friendly experience.<br>
      ...
      Such information will not be considered as sensitive if it is freely available and accessible in the public domain or is furnished under the Right to Information Act, 2005 or any other law for the time being in force.</p>
    ...
    <p>We shares the sensitive personal information to any third party without obtaining the prior consent of the user in the following limited circumstances:<br>
